...
const GoalScreen = ({ onNext, onBack, data, setData, topRight }) => {
      ...
      <div style={{ flex: 1, overflowY: "auto", padding: "24px 28px 32px" }}>
        ...
        <div style={{ marginBottom: "28px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "10px" }}>
            {[["Go Lighter","✦"],["Go Darker","◆"],["Low Maintenance","○"],["Full Transformation","◈"]].map(([goal, icon]) => (
        ...
        <button className="primary-btn" onClick={onNext} disabled={!canContinue} style={{ opacity: canContinue ? 1 : 0.4 }}>Generate Results</button>
      </div>
    </div>
  );
};
